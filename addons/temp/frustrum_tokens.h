...
#define CODNSS ( 1013) /* Segment not "smooth" but coincident with silhouette */
#define CODSMO ( 1014) /* Segment is "smooth" */
#define CODNSM ( 1015) /* Segment is not "smooth" */
#define CODUNS ( 1016) /* Segment "smoothness" is unknown */
#define CODSMS ( 1017) /* Segment "smooth" but coincident with silhouette */
...
#define CODESF ( 1024) /* Edge is coincident with sharp mfins */
#define CODNES ( 1025) /* Edge is not coincident with sharp mfins */
#define CODUES ( 1026) /* Edge coincidence with sharp mfins is unknown */
...
#define SGTPSF ( 2028) /* Sharp-fin line */
#define SGTPFI ( 2029) /* Face incremental (hierarchical segment) */
#define SGTPLI ( 2030) /* Lattice (heirarchical segment) */
#define SGTPLB ( 2031) /* Lattice ball */
#define SGTPLR ( 2032) /* Lattice rod */
...
#define L3TPFC ( 3023) /* Facet vertices + normals + curvatures */
#define L3TPFD ( 3024) /* Facet vertices + normals + parameters + curvatures */
#define L3TPTC ( 3025) /* Facet strip vxs + normals + curvatures */
#define L3TPTD ( 3026) /* Facet strip vxs + normals + parameters + curvatures */
#define L3TPCS ( 3027) /* Complete sphere */
#define L3TPCY ( 3028) /* Complete cylinder */
#define L3TPCN ( 3029) /* Complete truncated cone */
#define L3TPCP ( 3030) /* Complete circular paraboloid */
...
#define ERIFRM ( 4012) /* Incremental Facetting: required missing face */
#define ERIFRR ( 4013) /* Incremental Facetting: required due to refinement */
